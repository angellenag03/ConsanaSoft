 ...
 * @author pausa
 */
public class InstalarMaterialObraDialog extends JDialog {
    ...
    public InstalarMaterialObraDialog(JFrame parent, String obraId, String materialId, ObraPanel obraPanel) {
        super(parent, true);
        this.obraId = obraId;
